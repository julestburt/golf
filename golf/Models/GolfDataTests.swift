...
class GolfDataTests: XCTestCase {
    ...
    func testPlayers() {
        ...
        let json = try! JSON(data:jsonPlayerString!)
        ...
        let jsonNon = try! JSON(data:jsonNonPlayerString!)
    ...
    func testEvent() {
        ...
        let json = try! JSON(data:stringJSON!)
        print(json)
        ...
        let jsonNoID = try! JSON(data:stringJSONnoID!)
    ...
    func testEntries() {
        ...
        let jsonEntry1 = try! JSON(data: stringJSONEntry1!)
        ...
        let jsonEntry2 = try! JSON(data: stringJSONEntry2!)
